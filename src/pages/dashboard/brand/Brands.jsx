...
import AddCategoryModal from "./AddBrandModal";
import baseUrl from "../../../api/baseURL";
import Breadcrumbs from "../../../components/ui/Breadcrumbs";
import LoadingSpinner from "../../../components/ui/LoadingSpinner";
import EditCategoryModal from "./EditBrandModal";
...
const Brands = ({ title = "التصنيفات" }) => {
  ...
  const getAllData = async () => {
    // setIsLoading(true);
    try {
      let dataA = await baseUrl.get("api/Brand", {
        headers: {
